...
Route::get('/Admin/Brand/destroy', 'Pages\BrandController@destroy')->name('BrandController_Delete');
...
Route::get('/Admin/Product/destroy', 'Pages\ProductController@destroy')->name('ProductController_Delete');
